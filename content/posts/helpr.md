...
> `> LOG_ENTRY: HELPR_STARTUP_SPRINT`
> `> BUILD_SCOPE: PUBLIC_SAFETY_MVP`

## Problem
During emergencies, local updates can be fragmented across social media, news, and informal channels. People need nearby hazard information that is fast, clear, and location-aware.
...
- Used Firebase to support real-time emergency updates.
- Applied HCI and design-thinking principles to improve accessibility and visual clarity.
- Built around community validation to reduce unreliable reports.

## Tradeoffs
- Focused on MVP alert functionality rather than a full municipal emergency-management platform.
- Prioritized clarity and speed over feature breadth.
- Designed the concept to be adaptable for municipal use without overbuilding early.
